...
#Renaming and working using this data set.
depdata15to74 <- depdata.hours
...
#Converting working data set string data to numerical data using scales for analaysis.

depdata15to74$DEPDVSEV <- sapply(depdata15to74$DEPDVSEV,scale3)
depdata15to74$GEN_015 <- sapply(depdata15to74$GEN_015,scale1)
depdata15to74$GEN_020 <- sapply(depdata15to74$GEN_020,scale7)
depdata15to74$GEN_025 <- sapply(depdata15to74$GEN_025,scale7)
...
#Filter out responses that are not stated
depdata1 <- depdata.hours %>%
  filter(!LBFDGOCG %in% c("Not stated"),
         ...
         !GEN_015 %in% c("Not stated"),
         !GEN_020 %in% c("Not stated"),
         !GEN_025 %in% c("Not stated"),
