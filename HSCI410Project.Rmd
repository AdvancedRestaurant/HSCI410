...
full <- glm(depdata18to64.test$DODEP ~ depdata18to64.test$LBFDGHPW + depdata18to64.test$DOWST + factor.mentalhealth + factor.lifestress + factor.workstress + depdata18to64.test$LBFDVPFT + factor.worktype + depdata18to64.test$DHH_SEX + factor.martial + depdata18to64.test$SDCDGCGT + factor.perceivedhealth + factor.perceivedmenhealth + factor.incomepersonal + factor.incomehousehold + depdata18to64.test$ALCDVTTM + factor.alcfreq + factor.smkrtype + factor.smkstatus + factor.bmi + factor.edu, family = "binomial")
...
#Suggested model after stepwise 

dep.wrkhoursfull <-glm(formula = depdata18to64.test$DODEP ~ depdata18to64.test$DOWST + factor.martial + factor.alcfreq + factor.bmi + factor.lifestress + depdata18to64.test$LBFDGHPW + factor.smkstatus + factor.edu + factor.incomepersonal + factor.perceivedhealth + depdata18to64.test$SDCDGCGT + factor.mentalhealth + depdata18to64.test$LBFDVPFT + factor.incomehousehold + factor.worktype + depdata18to64.test$DHH_SEX, family = "binomial")
